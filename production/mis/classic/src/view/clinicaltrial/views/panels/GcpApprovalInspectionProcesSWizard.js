 ...
 */
Ext.define('Admin.view.clinicaltrial.views.panels.GcpApprovalInspectionProcesSWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.gcpapprovalinspectionprocesswizard',
        ...
        this.tbar = {
            ...
            items: [
                ...
                },
                {
                    ...
                    iconCls: 'fa fa-university',
                    enableToggle: true,
                    text: 'Inspection Approval Recommendation',
                    action: 'quickNav',
                    handler: 'quickInspectionNavigationMoreDetails'
                }
            ]
