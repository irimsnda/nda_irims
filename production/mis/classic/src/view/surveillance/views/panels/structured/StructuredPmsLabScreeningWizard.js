 ...
 */
/*Ext.define('Admin.view.surveillance.views.panels.structured.StructuredPmsLabScreeningWizard', {
    extend: 'Admin.view.surveillance.views.sharedinterfaces.panels.PmsLabScreeningWizard',
    xtype: 'structuredpmslabscreeningwizard'
});*/

Ext.define('Admin.view.surveillance.views.panels.structured.StructuredPmsLabScreeningWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.structuredpmslabscreeningwizard',
