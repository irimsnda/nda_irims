 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.cosmetics.new.OnlineCosmeticsReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.onlinecosmeticsreceivingwizard',
    padding: '2 0 2 0',
    requires: [
            ...
            items: [
                {
                    ...
                    action: 'quickNav',
                    wizard: 'onlinecosmeticsreceivingwizard',
