 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.drugs.OnlineAltDrugProductReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.onlinealtdrugproductreceivingwizard',
    padding: '2 0 2 0',
    requires: [
            ...
            items: [
                {
                    ...
                    action: 'quickNav',
                    wizard: 'onlinealtdrugproductreceivingwizard',
