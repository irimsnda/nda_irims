 ...
 */
Ext.define('Admin.view.productregistration.views.toolbars.AnimalFeedsProductRegTb', {
    ...
    items: [
        {
            ...
            name: 'animalfeedsProductRegHomeBtn'
        },
        {
        ...
        
        {
            ...
            menu:{
                ...
                items:[
                    {
                        text: 'New Animal Feeds Product Registration',
                        iconCls: 'x-fa fa-check',
                    ...
                    {
                        text: 'Animal Feeds Product Renewal',
                        iconCls: 'x-fa fa-check',
                        wrapper_xtype: 'foodproductRegDashWrapper',
                        handler:'showProductRegWorkflow',
                        app_type: 8
                    ...
                    {
                        text: 'Animal Feeds Product Alteration',
                        iconCls: 'x-fa fa-check',
                        wrapper_xtype: 'foodproductRegDashWrapper',
                        handler:'showProductRegWorkflow',
                        app_type: 9
