Ext.define('Admin.view.configurations.views.forms.DistrictCouncilsDefinationFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'districtcouncilsdefinationfrm',
        ...
        listeners: {
            ...
            afterrender:function(cbo){
                    var store = cbo.getStore(),
                        filter = {country_id: 246};
                        filter = JSON.stringify(filter);
                        store.load({params:{filters: filter}})
            }
        }
    },{
        xtype: 'textfield',
