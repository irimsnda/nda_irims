Ext.define('Admin.view.premiseregistration.views.grids.OnlinePromoAdvertsAnimalFeedsAppGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'promotionmaterialviewcontroller',
    xtype: 'onlinepromoadvertsanimalfeedsappgrid',
    autoScroll: true,
    autoHeight: true,
    width: '100%',
    isReadOnly: 1,
    ...
    export_title: 'Online Promotion advertisement applications',
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '100%',
        displayInfo: true,
    ...
    listeners: {
        beforerender: {
            fn: 'setPromotionMaterialOnlineGridsStore',
            config: {
                pageSize: 100000,
                storeId: 'onlinepromotionadvertsfoodapplicationstr',
				params:{'section_id':9,'sub_module_id':33},
                groupField: 'sub_module_id',
                proxy: {
                    url: 'promotionmaterials/getPromoAdvertsOnlineApplications'
                }
            },
            isLoad: true
        },
        //itemdblclick:'onDoubleClickPromotionAdvertOnlineAppGrid' //'previewOnlineApplication'
    },
    columns: [{
        xtype: 'gridcolumn',
        ...
        xtype: 'gridcolumn',
        dataIndex: 'manager_rejection_remark',
