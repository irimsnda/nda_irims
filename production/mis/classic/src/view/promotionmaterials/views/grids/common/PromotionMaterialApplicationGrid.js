Ext.define('Admin.view.view.promotionmaterials.views.grids.common.PromotionMaterialApplicationGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'promotionmaterialviewcontroller',
    xtype: 'promotionmaterialapplicationgrid',
    itemId: 'promotionmaterialapplicationgrid',
    ...
    tbar: [{
	 ...
	 {
        xtype: 'combo',
		wrapper_xtype:'promotionmaterialswrapper',
