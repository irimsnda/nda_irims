...
@Component({
  selector: 'app-shared-drugshopsregistrationclass',
  templateUrl: './shared-drugshopsregistrationclass.component.html',
  styleUrls: ['./shared-drugshopsregistrationclass.component.css']
})
@Pipe({ name: 'safe' })
