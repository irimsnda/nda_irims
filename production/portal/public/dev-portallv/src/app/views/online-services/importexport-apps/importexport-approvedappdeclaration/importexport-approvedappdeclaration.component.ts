...
export class ImportExportApprovedappDeclarationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.reloadPermitApplicationsApplications(this.tracking_no);
  }
  ...
  reloadPermitApplicationsApplications(tracking_no) {
    let filter_params = {application_status_id: '10' , sub_module_id: '115', tracking_no : tracking_no };
