 ...
 */
Ext.define('Admin.view.gmpapplications.views.grids.GmpConditionalApprovalsGrid', {
    ...
    dockedItems: [
        {
            ...
            items: [
                ...
                '->',
                {
                    ...
                    disabled: true,
                    table_name: 'tra_gmp_applications',
                    gridXtype:'gmpconditionalapprovalsgrid',//
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                pageSize: 10000,
                storeId: 'gmpconditionalapprovaldecisionsstr',
                proxy: {
                ...
                items: [
                    {
                        ...
                        interfaceXtype: 'newsinglegmpapproval',
                    ...
                    },
                    {
                        ...
                        stores: '["gmpconditionalapprovaldecisionsstr"]',
                        table_name: 'tra_gmp_applications'
                    },{
