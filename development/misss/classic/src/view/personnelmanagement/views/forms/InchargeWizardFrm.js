...
Ext.define('Admin.view.usermanagement.views.forms.InchargeWizardFrm', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.inchargewizardfrm',
    padding: '2 0 2 0',
        ...
        this.bbar = {
            ...
            items: [
                ...
                },
                {
                    ...
                    action: 'save',
                    ui: 'soft-purple',
                    handler: 'saveInchargeInformation'
                },
                {
                    text: 'Deactivate',
