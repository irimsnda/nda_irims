Ext.define('Admin.view.surveillance.views.panels.structured.StructuredManagerScreeningEvaluationWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.structuredmanagerscreeningevaluationwizard',
    ...
    items: [
        {
            xtype: 'structuredmanagerscreeningsamplegrid'//evaluationsampledetailsgrid
        },
        {
