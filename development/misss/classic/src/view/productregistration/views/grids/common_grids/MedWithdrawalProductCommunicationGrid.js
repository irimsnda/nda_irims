 ...
 */
Ext.define('Admin.view.productregistration.views.grids.common_grids.MedWithdrawalProductCommunicationGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'productregistrationvctr',
    xtype: 'medicalwithdrawalproductcommunicationgrid',
    ...
    columns: [{
        ...
        widget: {
            ...
            ui: 'soft-green',
            name: 'certificate',
            text: 'Withdrawal Letter',
            tooltip: 'Print Withdrawal Letter',
