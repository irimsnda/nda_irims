 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.food.AlterationFoodProductsReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.alterationfoodproductsreceivingwizard',
    padding: '2 0 2 0',
    requires: [
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                ...
                action: 'quickNav', wizard: 'alterationfoodproductsreceivingwizard',
            ...
            },
            {
                ...
                action: 'quickNav',
                wizard: 'alterationfoodproductsreceivingwizard',
                handler: 'quickNavigationRenewal'
            },
            {
                step: 2,
                ...
                iconCls: 'fa fa-edit',
                enableToggle: true,
                text: "ALTERATION REQUEST",iconAlign: 'top',
                action: 'quickNav', wizard: 'alterationfoodproductsreceivingwizard',
                handler: 'quickNavigationRenewal'
            },{
                step: 4,
        ...
        this.bbar = {
            ...
            items: [
                ...
                },
                {
                    ...
                    name: 'save_btn',
                    disabled: false,
                    wizardpnl: 'alterationfoodproductsreceivingwizard',
