 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.cosmetics.OnlineWithdrawalCosmeticsProductReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.onlinewithdrawalcosmeticsproductreceivingwizard',
    padding: '2 0 2 0',
    requires: [
    ...
    items: [
        ...
        {
            xtype: 'productwithdrawalreasonsonlinegrid'//'premisescreeninggrid'
        }
    ],
            ...
            items: [
                {
                    ...
                    action: 'quickNav',
                    wizard: 'onlinewithdrawaldrugproductreceivingwizard',
        ...
        this.bbar = {
            ...
            items: [
                ...
                },
                {
                    ...
                    ui: 'soft-purple',
                    iconCls: 'fa  fa-thumbs-up',is_invoicecheck:false,
