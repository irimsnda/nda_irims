 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.food.FoodProdWithdrawalReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.foodprodwithdrawalreceivingwizard',
    padding: '2 0 2 0',
    requires: [
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                ...
                action: 'quickNav', wizard: 'foodprodwithdrawalreceivingwizard',
            ...
            },
            {
                ...
                action: 'quickNav',
                wizard: 'foodprodwithdrawalreceivingwizard',
                handler: 'quickNavigationRenewal'
            },
            {
                step: 2,
        ...
        this.bbar = {
            ...
            items: [
                ...
                },
                {
                    ...
                    name: 'save_btn',
                    disabled: false,
                    wizardpnl: 'foodprodwithdrawalreceivingwizard',
