 ...
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.food.FoodProductAuditingPnl', {
    ...
    items: [ {
            ...
            items: [{
                ...
                title: '2nd Assessment Checklist or Uploads',
                itemId:'auditing_panel',xtype: 'tabpanel',
                layout:'fit', margin:5,
                items:[{
        ...
        },
        {
            ...
            {
                text: '1st Asessmnt Reports Reports',
                ui: 'soft-purple', 
                    ...
                    items: [
                        {
                                ...
                                winTitle: 'Evaluation Comments & Recommendations',
                                winWidth: '60%',
                                comment_type_id: 2,
                                name: 'comments_btn',
                                stores: '[]'
