 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.food.new.NewFoodProductReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.newfoodproductreceivingwizard',
    padding: '2 0 2 0',
    requires: [
            ...
            items: [
                {
                    ...
                    action: 'quickNav',wizard:'newfoodproductreceivingwizard',
                ...
                },
                {
                    ...
                    wizard: 'newfoodproductreceivingwizard',
                    handler: 'quickNavigation',
                }
            ]
        };
