 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.cosmetics.AlterationCosmeticsProductReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.alterationcosmeticsproductreceivingwizard',
    padding: '2 0 2 0',
    requires: [
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                ...
                action: 'quickNav', 
                wizard: 'alterationcosmeticsproductreceivingwizard',
            ...
            },
            {
                ...
                action: 'quickNav', wizard: 'alterationcosmeticsproductreceivingwizard',
                handler: 'quickNavigationRenewal'
            },{
                step: 4,
                iconCls: 'fa fa-money',
        ...
        this.bbar = {
            ...
            items: [
                ...
                },
                {
                    ...
                    name: 'save_btn',
                    disabled: false,
                    wizardpnl: 'alterationcosmeticsproductreceivingwizard',
