     ...
     public function getImportExportPersonalUsePermits(Request $req){
        try {
            ...
            $records = DB::table('tra_importexport_applications as t1')
                                ...
                                ->select(DB::raw("t1.*,t1.name as applicant_name,t1.id as active_application_id, t2.name as inspection_recommendation, t4.name as process_name, t5.name as workflow_stage"))
