Ext.define('Admin.view.promotionmaterials.views.maininterfaces.grids.PromotionAdvertsEvaluationCommentsGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'promotionmaterialviewcontroller',//'premiseregistrationvctr',//'premiseregistrationvctr',
    xtype: 'promotionadvertsevaluationcommentsgrid',
    ...
    listeners: {
        beforerender: {
           fn: 'setPromAdvertsRegGridsStore',//
            config: {
                pageSize: 10000,
