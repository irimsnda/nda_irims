 ...
 */
Ext.define('Admin.view.drugshopregistration.views.sharedinterfaces.panels.PreDrugShopInspectionPanel', {
    extend: 'Ext.panel.Panel',
    xtype: 'predrugshopinspectionpanel',
    layout: {
        type: 'border'
    },
    defaults: {
                   ...
                   title: 'Inspection Checklist'
                    ...
                    listeners:{
                        beforerender:function(pnl){
                            ...
                            premise_id = mainPnl.down('preinspectiondrugshopdetailsfrm').down('hiddenfield[name=premise_id]').getValue();
