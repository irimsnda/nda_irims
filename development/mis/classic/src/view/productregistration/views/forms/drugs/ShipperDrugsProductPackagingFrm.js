 ...
 * on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.forms.drugs.ShipperDrugsProductPackagingFrm', {
            ...
            afterrender: {
                ...
                isLoad: true
                         ...
                         if (record && record.get('has_quantity') === 1) { 
                               form.down('textfield[name=shipper_no_of_packs]').setVisible(true);
                               form.down('combo[name=shipper_si_unit_id]').setVisible(true);
                               form.down('combo[name=shipper_si_unit_id]').allowBlank = false;
                               form.down('combo[name=shipper_si_unit_id]').validate();
    ...
    {
        xtype: 'combo',
        name: 'shipper_container_material_id',
        allowBlank: true,
        queryMode: 'local',
                ...
                items:[
                    {
                        ...
                        name: 'shipper_no_of_packs',
                        hidden:true,
                        allowBlank: true
                    },
                    {
                        xtype: 'combo',
                        name: 'shipper_si_unit_id',
