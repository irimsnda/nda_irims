 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.food.OnlineWithdrawalFoodProductReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.onlinewithdrawalfoodproductreceivingwizard',
    padding: '2 0 2 0',
    requires: [
            ...
            items: [
                {
                    ...
                    action: 'quickNav',
                    wizard: 'onlinewithdrawalfoodproductreceivingwizard',
        ...
        this.bbar = {
            ...
            items: [
                ...
                },
                {
                    ...
                    winWidth: '50%',hidden: true,is_invoicecheck:false,
