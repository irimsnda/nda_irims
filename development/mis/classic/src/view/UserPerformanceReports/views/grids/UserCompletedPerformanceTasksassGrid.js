 ...
 */
Ext.define('Admin.view.dashboard.grids.UserCompletedPerformanceTasksassGrid', {
    ...
    features: [
        {
            ...
            groupHeaderTpl: '{[values.rows[0].data.process_name]}, [{rows.length} {[values.rows.length > 1 ? "Items" : "Item"]}]',
    ...
    listeners: {
        beforerender: {
           ...
           config: {
               ...
               proxy: {
                   url: 'dashboard/getUserCompletedAssignments'
               }
           },
           isLoad: true
       }
