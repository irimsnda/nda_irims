Ext.define('Admin.view.reports.appsreports.drugshopreport.grid.DrugshopTabularRepresentationGrid', {
    ...
    autoHeight: true,
    width: '100%',
    export_title:'Drug Shop Summary',
    viewConfig: {
                        ...
                        config: {
                            ...
                            grouper: {
                                groupFn: function (item) {
                                        ...
                                        return item.get('SubModule') + item.get('product_category');
