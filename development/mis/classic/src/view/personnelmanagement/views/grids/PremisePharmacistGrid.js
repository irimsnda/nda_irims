...
Ext.define('Admin.view.personnelmanagement.views.grids.PremisePharmacistGrid', {
    ...
    tbar: [{
        ...
        action: 'add',
        ui: 'soft-green',
        form: 'pharmacistpanel',
        handler: 'showSimplePharmacistPersonnelGridForm',
        stores: '[]'
    }, {
        xtype: 'exportbtn'
    }, {
    ...
    export_title: 'Premise Personnel',
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '100%',
        store: 'usersstr',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                proxy: {
                    url: 'personnelmanagement/getPremisePharmacistsDetails',
                    extraParams:{
        ...
        itemdblclick: 'showEditSystemPharmacistPersonnel'
    },
    columns: [{
        xtype: 'gridcolumn',
        ...
        widget: {
            ...
            menu: {
                ...
                items: [{
                    ...
                    handler: 'showUserEditSystemPharmacistPersonnel'
                }
                ]
            }
        }
