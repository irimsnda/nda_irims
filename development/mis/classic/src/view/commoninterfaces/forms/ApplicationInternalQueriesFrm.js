 ...
 */
Ext.define('Admin.view.commoninterfaces.forms.ApplicationInternalQueriesFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'applicationinternalqueriesfrm',
    ...
    dockedItems: [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    reload_base:1,
                    hidden: true,
                    action_url: 'api/saveApplicationInternalReQueryDetails',
