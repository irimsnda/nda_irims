 ...
 */
/*Ext.define('Admin.view.surveillance.views.panels.structured.StructuredPmsApprovalsWizard', {
    extend: 'Admin.view.surveillance.views.sharedinterfaces.panels.PmsApprovalsWizard',
    xtype: 'structuredpmsapprovalswizard'
});*/

Ext.define('Admin.view.surveillance.views.panels.structured.StructuredPmsApprovalsWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.structuredpmsapprovalswizard',
