 ...
 */
Ext.define('Admin.view.importexportpermits.views.grids.common_grids.ImportPremiseSelectionGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'importexportpermitsvctr',
    xtype: 'importpremiseselectiongrid',
    itemId: 'importpremiseselectiongrid',
