 ...
 */
Ext.define('Admin.view.importexportpermits.views.grids.common_grids.ImportExportPoeProductsGrid', {
    ...
    export_title: 'Import/Export POE Products',
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '80%',
        displayInfo: true,
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('importexportpoeproductsgrid').fireEvent('refresh', this);//
        }
    }],
    features: [{
        ftype: 'searching',
        ...
        afterrender: {
            ...
            config: {
                ...
                storeId: 'importexportpermitsproductsstr',
                    proxy: {
                        url: 'importexportpermits/getImportexportpoepermitsproductsDetails',
