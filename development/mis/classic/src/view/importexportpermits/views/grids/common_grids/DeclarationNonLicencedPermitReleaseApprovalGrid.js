 ...
 */
Ext.define('Admin.view.importexportpermits.views.grids.common_grids.DeclarationNonLicencedPermitReleaseApprovalGrid', {
    extend: 'Ext.grid.Panel',
    xtype: 'declarationnonlicencedpermitreleaseapprovalgrid',
    listeners: {
        beforerender: {
    ...
    
    {
    ...
    },
     {
        ...
        text: 'Declaration Release Recommendation',
        flex: 1
    }, {
        xtype: 'widgetcolumn',
        width: 150,
            ...
            menu: {
                ...
                items: [{
                    ...
                    },
                    {
                        ...
                        handler: 'editpreviewdeclarationnonlicencedinformation'
                    }
                ]
            }
        }
