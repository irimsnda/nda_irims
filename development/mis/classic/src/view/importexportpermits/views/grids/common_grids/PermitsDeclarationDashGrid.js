 ...
 */
Ext.define('Admin.view.importexportpermits.views.grids.common_grids.PermitsDeclarationDashGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'importexportpermitsvctr',
    xtype: 'permitsdeclarationdashgrid',
    itemId: 'permitsdeclarationdashgrid',
    ...
    export_title: 'Import/Export Permits Declarations',
    ...
    columns: [{
        xtype: 'gridcolumn',
        dataIndex: 'declaration_reference_no',
        text: 'Permit Declaration Number',
        flex: 1
    }, {
        xtype: 'gridcolumn',
