 ...
 */
Ext.define('Admin.view.importexportpermits.views.grids.common_grids.ControlledDrugsLicensePermitsGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'importexportpermitsvctr',
    xtype: 'controlleddrugslicensepermitsgrid',
    itemId: 'controlleddrugslicensepermitsgrid',
    ...
    bbar: [{
        ...
        beforeLoad: function () {
            ...
            this.up('controlleddrugslicensepermitsgrid').fireEvent('refresh', this);
