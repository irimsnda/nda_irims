 ...
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panels.VcReceivingPermitsWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.vcreceivingpermitswizard',
    padding: '2 0 2 0',
    requires: [
            ...
            items: [
                {
                    ...
                    wizard: 'vcreceivingpermitswizard',
                ...
                },
                {
                    ...
                    action: 'quickNav', wizard: 'vcreceivingpermitswizard',
                    handler: 'quickNavigation'
                },
                {
                    step: 2,
