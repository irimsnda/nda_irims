 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panels.ImportExportReceivingLicenceWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.importexportreceivinglicencewizard',
    padding: '2 0 2 0',
    requires: [
        ...
        //  },  
         {
            ...
            title: 'Import/Export Licence Prechecking'
        },
        {
            xtype: 'hiddenfield',
            name: 'active_application_id'
            ...
            items: [
                {
                    ...
                    text: 'Applicant',
                    iconAlign: 'top',
                    action: 'quickNav',max_step:4,
                    wizard: 'importexportreceivinglicencewizard',
                ...
                },
                {
                    ...
                    action: 'quickNav', wizard: 'importexportreceivinglicencewizard',
                    handler: 'quickNavigation'
                }, {
                    step: 2,
                    iconCls: 'fa fa-university',
