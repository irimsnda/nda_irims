 ...
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panels.ImportExportLicenceManagerReviewWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.importexportlicencemanagerreviewwizard',
    padding: '2 0 2 0',
    requires: [
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                    ...
                    wizard: 'importexportlicencemanagerreviewwizard',
