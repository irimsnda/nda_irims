 ...
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panels.NonLicencedReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.nonlicencedreceivingwizard',
    padding: '2 0 2 0',
    requires: [
        ...
        this.tbar = {
            ...
            items: [
                ...
                },
                {
                    ...
                    action: 'quickNav', wizard: 'nonlicencedreceivingwizard',
                    handler: 'quickNavigation'
                },
                // {
                //     step: 2,
