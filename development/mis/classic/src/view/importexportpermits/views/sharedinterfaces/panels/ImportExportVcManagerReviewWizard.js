 ...
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panels.ImportExportVcManagerReviewWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.importexportvcmanagerreviewwizard',
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                    ...
                    wizard: 'importexportvcmanagerreviewwizard',
                    handler: 'quickNavigationReview',
                    bind: {
                        text: 'VC Application Details'
                    },
                }
            ]
        };
