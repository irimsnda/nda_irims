 ...
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panel.ImportExportNonLicenseOnlineReceivingWizard', {
	extend: 'Ext.panel.Panel',
    alias: 'widget.importexportnonlicenseonlinereceivingwizard',
    padding: '2 0 2 0',
    requires: [
    ...
    items: [
        ...
        {
            xtype: 'onlineimportexportnonlicencePnl',//onlinefoodproductsdetailspnl
            dockedItems: [
                {
                    xtype: 'toolbar',
                    ui: 'footer',
            ...
            items: [
                {
                    ...
                    action: 'quickNav', 
                    wizard: 'importexportnonlicenseonlinereceivingwizard',
