 ...
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panels.PreviewImportExportNonLicencedDetails', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.previewimportexportnonlicenceddetails',
    padding: '2 0 2 0',
    requires: [
    ...
    items: [
        {
            xtype: 'importexportnonlicencedetailspnl',//onlinefoodproductsdetailspnl
            dockedItems: [
                {
                    xtype: 'toolbar',
                    ui: 'footer',
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                    ...
                    action: 'quickNav', 
                    wizard: 'previewimportexportnonlicenceddetails',
