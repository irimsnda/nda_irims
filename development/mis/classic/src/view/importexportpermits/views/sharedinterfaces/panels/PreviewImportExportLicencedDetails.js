 ...
 * Kip on 9/24/2018.
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panels.PreviewImportExportLicencedDetails', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.previewimportexportlicenceddetails',
    padding: '2 0 2 0',
    requires: [
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                    ...
                    action: 'quickNav', 
                    wizard: 'previewimportexportlicenceddetails',
