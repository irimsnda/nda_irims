 ...
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panel.ImportExportAppMoreDetailsWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.importexportappmoredetailswizard',
    itemId: 'importexportappmoredetailswizard',
            ...
            items: [
                {
                    ...
                    action: 'quickNav',
                    wizard:'importexportappmoredetailswizard',max_step:5,
                ...
                },
                {
                    ...
                    enableToggle: true,
                    text: 'STUDY SITES',
                    action: 'quickNav',wizard:'importexportappmoredetailswizard',max_step:5,
                    handler: 'quickNavigationMoreDetails'
                },
                {
                    step: 3,
            ...
            items: [
                {
                    ...
                    name: 'prev_btn',wizard:'importexportappmoredetailswizard',max_step:5,
                ...
                },
                {
                    ...
                    name: 'next_btn',wizard:'importexportappmoredetailswizard',max_step:5,
