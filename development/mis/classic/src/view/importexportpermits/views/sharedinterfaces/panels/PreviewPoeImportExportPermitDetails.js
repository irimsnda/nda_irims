 ...
 */
Ext.define('Admin.view.importexportpermits.views.sharedinterfaces.panels.PreviewPoeImportExportPermitDetails', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.previewpoeimportexportpermitdetails',
    padding: '2 0 2 0',
    requires: [
    ...
    items: [
        {
            xtype: 'poepreviewdetailspnl',//onlinefoodproductsdetailspnl
            dockedItems: [
                {
                    xtype: 'toolbar',
                    ui: 'footer',
    ...
    initComponent: function () {
        ...
        this.tbar = {
            ...
            items: [{
                    ...
                    enableToggle: true,
                    text: 'Import/Export POE Details',
                    action: 'quickNav', 
                    wizard: 'PreviewPoeImportExportPermitDetails',
