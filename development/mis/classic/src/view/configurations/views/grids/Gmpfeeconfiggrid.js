...
Ext.define('Admin.view.configurations.views.grids.Gmpfeeconfiggrid', {
    ...
    tbar: [{
        ...
        action: 'add',
        ui: 'soft-green',
        childXtype: 'gmpfeeconfigfrm',
        winTitle: 'GMP Fee Configurations',
        winWidth: '70%',
    ...
    export_title: 'Gmp Fee Configurations',
    bbar: [{
        xtype: 'pagingtoolbar',
        width: '100%',
        displayInfo: true,
