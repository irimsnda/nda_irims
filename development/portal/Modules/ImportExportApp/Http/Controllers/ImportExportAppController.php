        ...
        try {
            ...
            $app_data = array(
               'section_id'=>$req->section_id,
                                    ...
                                    'business_type_id'=>$req->business_type_id,
                                    'premise_id'=>$req->premise_id,
                                   //'premises_name'=>$req->premise_name,
        ...
        foreach ($records as $rec) {
           ...
           $data[] = array('reference_no'=>$rec->reference_no,
                          ...
                          // 'application_type'=>returnParamFromArray($subModuleData,$rec->sub_module_id).' Application',
                           ...
                           'tpin_id'=>$rec->tpin_id,
                           'importexport_product_range_id'=>json_decode(json_decode($rec->importexport_product_range_id)),
            ...
            if($req->searchValue != 'undefined'){
                ...
                $searchValue =  '';
                      ...
                      $qry = DB::connection('mis_db')
                        ...
                        ->leftjoin('par_confirmations as t2','t1.co_pack','=','t2.id')
                        ->leftjoin('par_product_fdc as t3','t1.single_fixed_dose','=','t3.id')
                        ->leftjoin('par_packaging_units as t4','t1.si_unit_id','=','t4.id')
                        ->leftjoin('par_common_names as t5','t1.common_name_id','=','t5.id')
                        ->leftjoin('par_atc_codes as t6','t1.atc_code_id','=','t6.id')
                        ->leftjoin('classification as t7','t1.classification','=','t7.id')
                        ->leftjoin('par_prodclass_categories as t8','t1.class_category','=','t8.id')
                        ->leftjoin('par_therapeutic_group as t9','t1.therapeutic_group','=','t9.id')
                        ->leftjoin('par_distribution_categories as t10','t1.distribution_category','=','t10.id')
                        ->leftjoin('par_route_of_administration as t11','t1.route_of_administarion','=','t11.id')
                        ->select('t1.*', 't2.name as copack', 't3.name as dose', 't4.name as siunit', 't5.name as genericname', 't6.name as atccode', 't7.name as classification_name', 't8.name as classcategory', 't9.name as therapeuticgroup', 't10.name as categories', 't11.name as administarion');
