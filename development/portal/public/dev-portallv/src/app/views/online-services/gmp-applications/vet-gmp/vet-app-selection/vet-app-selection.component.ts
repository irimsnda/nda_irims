...
@Component({
  selector: 'app-vet-app-selection',
  templateUrl: './vet-app-selection.component.html',
  styleUrls: ['./vet-app-selection.component.css']
})
export class VetAppSelectionComponent  extends SharedDashboardclassComponent  implements OnInit {
  ...
  onGmpBackToDashboard() {
    this.app_route = ['./online-services/vetgmpapplications-dashboard'];
    this.router.navigate(this.app_route);
  }
}
