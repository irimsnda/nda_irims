...
if(app_connection == 'development'){
  ...
  var base_url = 'http://localhost:81/nda_irims/development/portal/'
 var  assets_url = 'http://localhost:81/nda_irims/development/portal/public/resources/';

  var mis_url = 'localhost:81/nda_irims/development/mis';
