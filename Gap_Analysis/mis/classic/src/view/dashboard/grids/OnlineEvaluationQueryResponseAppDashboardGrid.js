 ...
 */
Ext.define('Admin.view.dashboard.grids.OnlineEvaluationQueryResponseAppDashboardGrid', {
    ...
    bbar: [
        {
            xtype: 'pagingtoolbar',
            displayInfo: true,
            store: 'onlineevalqueryresponseappdashboardgridstr',
            width: '60%',
            beforeLoad: function () {
