 ...
 */
Ext.define('Admin.view.importexportpermits.views.grids.common_grids.ImportExportProductsValidationGrid', {
    extend: 'Ext.grid.Panel',
    xtype: 'importexportproductsvalidationgrid',
    listeners: {
    ...
    bbar: [{
        ...
        emptyMsg: 'No Records',
        beforeLoad: function () {
            this.up('importexportproductsvalidationgrid').fireEvent('refresh', this);//
        }
    }],
    selModel: {
        selType: 'checkboxmodel',
    ...
    columns: [{
        ...
        widget: {
            ...
            xtype: 'button',
            ui: 'soft-green',
            text: 'Products(Non-Registered) Validation Recommendation',
            iconCls: 'x-fa fa-certificate',
            name: 'certificate',
            winTitle:'Products(Non-Registered) Validation Recommendation',
            winWidth: '80%',
            childXtype: 'importvisaproductsvalidationpnl',
