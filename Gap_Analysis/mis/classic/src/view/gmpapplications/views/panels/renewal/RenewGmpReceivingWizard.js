 ...
 */
Ext.define('Admin.view.gmpapplications.views.panels.renewal.RenewGmpReceivingWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.renewgmpreceivingwizard',
            ...
            items: [
                {
                    ...
                    listeners: {
                        ...
                        change: function (cmbo, newVal) {
                            var pnl = cmbo.up('renewgmpreceivingwizard'),
