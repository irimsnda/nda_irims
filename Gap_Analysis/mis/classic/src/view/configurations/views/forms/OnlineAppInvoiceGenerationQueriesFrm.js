 ...
 */
Ext.define('Admin.view.configurations.views.forms.OnlineAppInvoiceGenerationQueriesFrm', {
    extend: 'Ext.form.Panel',
    xtype: 'onlineappinvoicegenerationqueriesfrm',
    autoScroll: true,
    ...
    items: [{
        ...
        margin: '0 20 20 0',
        name: 'table_name',
        value: 'wb_applicationinvoicedata_queries',
        allowBlank: true
    }, {
        xtype: 'hiddenfield',
        margin: '0 20 20 0',
