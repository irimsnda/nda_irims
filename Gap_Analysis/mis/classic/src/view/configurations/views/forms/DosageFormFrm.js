 ...
 */
Ext.define('Admin.view.configurations.views.forms.DosageFormFrm', {
    ...
    items: [{
        ...
        allowBlank: true
            ...
            xtype: 'combo',
            fieldLabel: 'Lims Dosage Form',
            name: 'lims_dosage_form_id',
            forceSelection: true,
            queryMode: 'local',
            allowBlank: true,
            anyMatch: true,
