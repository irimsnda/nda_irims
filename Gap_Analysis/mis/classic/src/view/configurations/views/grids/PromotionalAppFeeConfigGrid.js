...
Ext.define('Admin.view.configurations.views.grids.PromotionalAppFeeConfigGrid', {
    ...
    tbar: [{
        ...
        action: 'add',
        ui: 'soft-green',
        childXtype: 'promotionalappfeeconfigfrm',
        winTitle: 'Promotional Fee Configurations',
        winWidth: '70%',
