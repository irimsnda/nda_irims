 ...
 */
Ext.define('Admin.view.productregistration.views.toolbars.FoodProductRegTb', {
    ...
    items: [
        ...
        },
        {
            ...
            menu:{
                ...
                items:[
                    {
                        text: 'New Food Product Registration',
                        iconCls: 'x-fa fa-check',
