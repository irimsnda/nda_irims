 ...
 */
Ext.define('Admin.view.productregistration.views.sharedinterfaces.panels.medicaldevices.MedicalDeviceNewEvaluationPnl', {
    ...
    items: [{
        ...
        },
        {
            ...
            {
                text: 'Product Application Documents',
