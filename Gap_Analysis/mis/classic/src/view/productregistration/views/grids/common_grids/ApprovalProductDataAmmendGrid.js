 ...
 * on 10/16/2018.
 */
Ext.define('Admin.view.productregistration.views.grids.common_grids.ApprovalProductDataAmmendGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'productregistrationvctr',
    xtype: 'approvalproductdataammendgrid',
    ...
    listeners: {
        beforerender: {
            ...
            config: {
                ...
                table_name: 'tra_product_applications',
                proxy: {
                    url: 'productregistration/getManagerProductDataAmmendApps'
                },
            },
            isLoad: true
        },
    ...
    columns: [{
        ...
        widget: {
            ...
            menu: {
                xtype: 'menu',
                items: [{
                    text: 'Preview Ammendment Requests Details',
