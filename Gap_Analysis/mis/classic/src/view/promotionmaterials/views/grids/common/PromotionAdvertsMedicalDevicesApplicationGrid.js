Ext.define('Admin.view.promotionmaterials.views.grids.common.PromotionAdvertsMedicalDevicesApplicationGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'promotionmaterialviewcontroller',
    xtype:  'promotionadvertsmedicaldevicesapplicationgrid',
    itemId: 'promotionadvertsmedicaldevicesapplicationgrid',
    ...
    tbar: [{
	 ...
	 {
        xtype: 'combo',
		wrapper_xtype:'cosmeticpromoadverts',
    ...
    listeners: {
        itemdblclick:'onDoubleClickPromotionMaterialsDashBoardGrid' 
    },
    features: [{
        ftype: 'searching',
        minChars: 2,
