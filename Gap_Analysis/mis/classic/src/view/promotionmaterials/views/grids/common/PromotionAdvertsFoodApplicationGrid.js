Ext.define('Admin.view.view.promotionmaterials.views.grids.common.PromotionAdvertsFoodApplicationGrid', {
    extend: 'Ext.grid.Panel',
    controller: 'promotionmaterialviewcontroller',
	//store:'',
    xtype: 'promotionadvertsfoodapplicationgrid',
    itemId: 'promotionadvertsfoodapplicationgrid',
    ...
    tbar: [{
	 ...
	 {
        xtype: 'combo',
		wrapper_xtype:'promotionadvertsfoodwrapper',
