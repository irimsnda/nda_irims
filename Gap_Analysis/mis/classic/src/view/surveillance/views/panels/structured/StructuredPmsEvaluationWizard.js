 ...
 */
/*Ext.define('Admin.view.surveillance.views.panels.structured.StructuredPmsEvaluationWizard', {
    extend: 'Admin.view.surveillance.views.sharedinterfaces.panels.PmsEvaluationWizard',
    xtype: 'structuredpmsevaluationwizard'
});*/

Ext.define('Admin.view.surveillance.views.panels.structured.StructuredPmsEvaluationWizard', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.structuredpmsevaluationwizard',
    ...
    items: [
        {
            xtype: 'evaluationsampledetailsgrid'
        },
        {
