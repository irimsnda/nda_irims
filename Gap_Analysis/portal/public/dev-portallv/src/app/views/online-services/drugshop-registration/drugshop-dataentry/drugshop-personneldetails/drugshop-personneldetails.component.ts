...
@Component({
  selector: 'app-drugshop-personneldetails',
  templateUrl: './drugshop-personneldetails.component.html',
  styleUrls: ['./drugshop-personneldetails.component.css']
})
export class DrugshopPersonneldetailsComponent implements OnInit {
