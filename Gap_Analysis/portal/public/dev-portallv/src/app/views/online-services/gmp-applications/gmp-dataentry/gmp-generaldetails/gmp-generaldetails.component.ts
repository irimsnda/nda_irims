...
/*
  ...
  funcSelectBillingPremisePersonnel(data) {
    if(this.personnel_type_id == 1){
      this.gmpapplicationGeneraldetailsfrm.patchValue({ billing_person_id: data.data.id, billing_person: data.data.name})
    }
            ...
            response => {
              ...
              if (app_resp.success) {
                if(this.personnel_type_id == 1){
                  ...
                  this.gmpapplicationGeneraldetailsfrm.patchValue({ billing_person_id: app_resp.record_id, billing_person: name})
                }
