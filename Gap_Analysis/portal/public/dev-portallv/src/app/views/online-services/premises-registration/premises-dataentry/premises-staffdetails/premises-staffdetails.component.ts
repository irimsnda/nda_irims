...
@Component({
  selector: 'app-premises-staffdetails',
  templateUrl: './premises-staffdetails.component.html',
  styleUrls: ['./premises-staffdetails.component.css']
})
export class PremisesStaffdetailsComponent implements OnInit {
